...
namespace WebCore.Migrations
{
    ...
    [Migration("20251120020654_Add_Restaurant_Booking_Entities")]
    partial class Add_Restaurant_Booking_Entities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebCore.Restaurants.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebCore.Restaurants.Restaurant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebCore.Restaurants.Table", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("WebCore.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("WebCore.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("WebCore.Restaurants.Booking", b =>
                {
                    b.HasOne("WebCore.Restaurants.Restaurant", "Restaurant")
                        .WithMany("Bookings")
                        .HasForeignKey("RestaurantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebCore.Restaurants.Table", "Table")
                        .WithMany("Bookings")
                        .HasForeignKey("TableId");

                    b.HasOne("WebCore.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
