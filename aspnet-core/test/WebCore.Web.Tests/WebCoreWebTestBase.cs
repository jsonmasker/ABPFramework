...
public abstract class WebCoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static WebCoreWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(WebCoreWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<WebCoreDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<WebCoreDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<WebCoreDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<WebCoreDbContext, Task<T>> func)
    {
        T result;
